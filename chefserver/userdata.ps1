<powershell>
 ...
 $env:CHEF_SERVER_NAME = "MyChef" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "mychef-fkyl22mwwlujex8a.us-west-2.opsworks-cm.io" # FQDN of your Chef Server
