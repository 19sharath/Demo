...
CHEF_SERVER_NAME="MyChef" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="mychef-fkyl22mwwlujex8a.us-west-2.opsworks-cm.io" # The FQDN of your Chef Server
